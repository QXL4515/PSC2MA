 ...
 *
 */
public class CreateEnvironmentLifelineCommand extends Command {
	...
	public CreateEnvironmentLifelineCommand(Shell shell){
		super();
		this.shell=shell;
	}
//	
...
//	}
	...
	public void redo(){
	    InputDialog dlg = new InputDialog(shell, "Set the name of EnvironmentLifeline", "New EnvironmentLifeline's name:", "EnvironmentLifeline", null);
